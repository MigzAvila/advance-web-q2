	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('todo-container text-left p-24 bg-white shadow-sm rounded flex flex-col mx-auto my-48')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onSubmit($author$project$Quiz3$AddTodo)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$placeholder('Title here..'),
